...
public sealed partial class OrganDamageOnDamageSystem : OffbrandDamageSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<OrganDamageOnDamageComponent, BodyRelayedEvent<DamageDealtEvent>>(OnDamageDealt);
    }

    private void OnDamageDealt(Entity<OrganDamageOnDamageComponent> ent, ref BodyRelayedEvent<DamageDealtEvent> args)
    {
        var delta = args.Args.Damage;
        if (delta.Empty || !delta.AnyPositive())
            return;
