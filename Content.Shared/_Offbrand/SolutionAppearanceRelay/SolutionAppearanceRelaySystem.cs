...
public sealed partial class SolutionAppearanceRelaySystem : EntitySystem
{
    ...
    private void UpdateAppearance(Entity<SolutionAppearanceRelayComponent> ent)
    {
        ...
        _appearance.SetData(container.Owner, SolutionContainerVisuals.FillFraction, solution.FillFraction);
        _appearance.SetData(container.Owner, SolutionContainerVisuals.Color, solution.GetColor(null));
